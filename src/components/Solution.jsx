...
import { solutionsData } from '../data/content.jsx';
    ...
    <section className="solution-section section-padding section-shell section-shell-cool" id="solution">
      <div className="container">
        <div className="solution-layout">
          ...
          >
            <span className="section-badge solution-badge">The Solution</span>
            <h2 className="section-title">Medora creates a connected healthcare ecosystem.</h2>
            <p className="solution-desc">
              We seamlessly integrate tools designed to prioritize your wellness above all else, 
              connecting every dot in your health journey into one single, powerful platform.
            </p>
            <motion.div 
            ...
            <button className="btn btn-primary mt-8">Explore Our Ecosystem</button>
          </motion.div>
